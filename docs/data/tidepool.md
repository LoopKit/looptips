...
As part of *Tidepool* *Loop* development, *Tidepool* updated its *Tidepool* Mobile iOS app to integrate with *Loop* user's data stored in Apple's HealthKit database. This update also supports the [Jaeb Center observational study](jaeb.org/loopstudy){: target="_blank" } of Loop.
